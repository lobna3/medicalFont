...
@Component({
  selector: 'app-scretarys',
  templateUrl: './scretarys.component.html',
  styleUrls: ['./scretarys.component.css']
})
export class ScretarysComponent implements OnInit {
  user: User = new User();
  scretarys: User[]
